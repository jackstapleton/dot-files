...
"	highlight Normal ctermfg=223 ctermbg=234 guifg=#ebdbb2 guibg=#282828
	highlight DiffAdd ctermfg=142 ctermbg=234 gui=bold guifg=#b8bb26 guibg=#282828
	highlight DiffChange ctermfg=108 ctermbg=234 gui=bold guifg=#8ec07c guibg=#282828
	highlight DiffDelete ctermfg=167 ctermbg=234 gui=bold guifg=#fb4934 guibg=#282828
	highlight DiffText ctermfg=214 ctermbg=234 gui=bold guifg=#fabd2f guibg=#282828
